...
#ifndef SEAL_ORAM_RECURSIVEPATHORAM_H_H
#define SEAL_ORAM_RECURSIVEPATHORAM_H_H
...
class RecursivePathORAM: public ORAM {
public:
    RecursivePathORAM(const uint32_t& n);
    virtual ~RecursivePathORAM();
...
private:
    ...
    std::unordered_map<uint32_t, uint32_t> stash_posmap;
...
#endif //SEAL_ORAM_RECURSIVEPATHORAM_H_H
